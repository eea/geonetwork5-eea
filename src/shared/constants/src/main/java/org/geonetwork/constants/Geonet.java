...
public final class Geonet {
    ...
    public static final class Path {
        public static final String SCHEMAS = "TODO/schemas/";
    ...
    public static final class SearchResult {
        ...
        public static final String EXTRA_DUMP_FIELDS = "extraDumpFields";
    ...
    public static final class Namespaces {
        ...
        public static final Namespace OASIS_CATALOG =
                Namespace.getNamespace("urn:oasis:names:tc:entity:xmlns:xml:catalog");
