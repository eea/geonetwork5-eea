...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        final String message = "Invalid information supplied"; // ex.getLocalizedMessage()
        final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, message, errors);
    ...
    public ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        if (requiredType != null) {
            error = ex.getName() + " should be of type " + requiredType.getName();
        } else {
            error = ex.getName() + " has an invalid type";
        }
