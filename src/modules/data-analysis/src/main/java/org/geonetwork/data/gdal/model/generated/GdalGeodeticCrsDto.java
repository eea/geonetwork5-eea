...
@Schema(name = "geodetic_crs", description = "One and only one of datum and datum_ensemble must be provided")
...
public class GdalGeodeticCrsDto implements GdalCrsDto {
    ...
    public GdalGeodeticCrsDto deformationModels(List<@Valid GdalDeformationModelDto> deformationModels) {
        this.deformationModels = deformationModels;
        return this;
    }

    public GdalGeodeticCrsDto addDeformationModelsItem(GdalDeformationModelDto deformationModelsItem) {
