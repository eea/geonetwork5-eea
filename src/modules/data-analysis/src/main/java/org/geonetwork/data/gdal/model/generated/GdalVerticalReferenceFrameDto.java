...
/** GdalVerticalReferenceFrameDto */
@JsonTypeName("vertical_reference_frame")
@JacksonXmlRootElement(localName = "GdalVerticalReferenceFrameDto")
@XmlRootElement(name = "GdalVerticalReferenceFrameDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalVerticalReferenceFrameDto implements GdalDatumDto, GdalGdalVerticalCrsDatumDtoOneOfDto {
    ...
    public GdalVerticalReferenceFrameDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalVerticalReferenceFrameDto(String name) {
        this.name = name;
    }

    public GdalVerticalReferenceFrameDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalVerticalReferenceFrameDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalVerticalReferenceFrameDto anchor(String anchor) {
        this.anchor = anchor;
        return this;
    }
    ...
    public GdalVerticalReferenceFrameDto $schema(Object $schema) {
    ...
    public GdalVerticalReferenceFrameDto scope(Object scope) {
    ...
    public GdalVerticalReferenceFrameDto area(Object area) {
    ...
    public GdalVerticalReferenceFrameDto bbox(Object bbox) {
    ...
    public GdalVerticalReferenceFrameDto verticalExtent(Object verticalExtent) {
    ...
    public GdalVerticalReferenceFrameDto temporalExtent(Object temporalExtent) {
    ...
    public GdalVerticalReferenceFrameDto usages(Object usages) {
    ...
    public GdalVerticalReferenceFrameDto remarks(Object remarks) {
    ...
    public GdalVerticalReferenceFrameDto id(Object id) {
    ...
    public GdalVerticalReferenceFrameDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalVerticalReferenceFrameDto verticalReferenceFrame = (GdalVerticalReferenceFrameDto) o;
        return Objects.equals(this.type, verticalReferenceFrame.type)
                && Objects.equals(this.name, verticalReferenceFrame.name)
                && Objects.equals(this.anchor, verticalReferenceFrame.anchor)
                && equalsNullable(this.$schema, verticalReferenceFrame.$schema)
                && equalsNullable(this.scope, verticalReferenceFrame.scope)
                && equalsNullable(this.area, verticalReferenceFrame.area)
                && equalsNullable(this.bbox, verticalReferenceFrame.bbox)
                && equalsNullable(this.verticalExtent, verticalReferenceFrame.verticalExtent)
                && equalsNullable(this.temporalExtent, verticalReferenceFrame.temporalExtent)
                && equalsNullable(this.usages, verticalReferenceFrame.usages)
                && equalsNullable(this.remarks, verticalReferenceFrame.remarks)
                && equalsNullable(this.id, verticalReferenceFrame.id)
                && equalsNullable(this.ids, verticalReferenceFrame.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalVerticalReferenceFrameDto {\n");
    ...
    public static class Builder {
        ...
        private GdalVerticalReferenceFrameDto instance;

        public Builder() {
            this(new GdalVerticalReferenceFrameDto());
        }

        protected Builder(GdalVerticalReferenceFrameDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalVerticalReferenceFrameDto value) {
        ...
        /**
         * returns a built GdalVerticalReferenceFrameDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalVerticalReferenceFrameDto build() {
            try {
