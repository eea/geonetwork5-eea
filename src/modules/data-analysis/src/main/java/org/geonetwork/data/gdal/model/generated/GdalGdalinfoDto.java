...
public class GdalGdalinfoDto {
    ...
    @Valid
    private List<BigDecimal> geoTransform = new ArrayList<>();
    ...
    @Valid
    private List<@Valid GdalBandDto> bands = new ArrayList<>();
    ...
    public String toString() {
        ...
        sb.append("    cornerCoordinates: ")
                .append(toIndentedString(cornerCoordinates))
                .append("\n");
