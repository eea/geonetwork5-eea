...
/** GdalEngineeringDatumDto */
@JsonTypeName("engineering_datum")
@JacksonXmlRootElement(localName = "GdalEngineeringDatumDto")
@XmlRootElement(name = "GdalEngineeringDatumDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalEngineeringDatumDto implements GdalDatumDto {
    ...
    public GdalEngineeringDatumDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalEngineeringDatumDto(String name) {
        this.name = name;
    }

    public GdalEngineeringDatumDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalEngineeringDatumDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalEngineeringDatumDto anchor(String anchor) {
        this.anchor = anchor;
        return this;
    }
    ...
    public GdalEngineeringDatumDto $schema(Object $schema) {
    ...
    public GdalEngineeringDatumDto scope(Object scope) {
    ...
    public GdalEngineeringDatumDto area(Object area) {
    ...
    public GdalEngineeringDatumDto bbox(Object bbox) {
    ...
    public GdalEngineeringDatumDto verticalExtent(Object verticalExtent) {
    ...
    public GdalEngineeringDatumDto temporalExtent(Object temporalExtent) {
    ...
    public GdalEngineeringDatumDto usages(Object usages) {
    ...
    public GdalEngineeringDatumDto remarks(Object remarks) {
    ...
    public GdalEngineeringDatumDto id(Object id) {
    ...
    public GdalEngineeringDatumDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalEngineeringDatumDto engineeringDatum = (GdalEngineeringDatumDto) o;
        return Objects.equals(this.type, engineeringDatum.type)
                && Objects.equals(this.name, engineeringDatum.name)
                && Objects.equals(this.anchor, engineeringDatum.anchor)
                && equalsNullable(this.$schema, engineeringDatum.$schema)
                && equalsNullable(this.scope, engineeringDatum.scope)
                && equalsNullable(this.area, engineeringDatum.area)
                && equalsNullable(this.bbox, engineeringDatum.bbox)
                && equalsNullable(this.verticalExtent, engineeringDatum.verticalExtent)
                && equalsNullable(this.temporalExtent, engineeringDatum.temporalExtent)
                && equalsNullable(this.usages, engineeringDatum.usages)
                && equalsNullable(this.remarks, engineeringDatum.remarks)
                && equalsNullable(this.id, engineeringDatum.id)
                && equalsNullable(this.ids, engineeringDatum.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalEngineeringDatumDto {\n");
    ...
    public static class Builder {
        ...
        private GdalEngineeringDatumDto instance;

        public Builder() {
            this(new GdalEngineeringDatumDto());
        }

        protected Builder(GdalEngineeringDatumDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalEngineeringDatumDto value) {
        ...
        /**
         * returns a built GdalEngineeringDatumDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalEngineeringDatumDto build() {
            try {
