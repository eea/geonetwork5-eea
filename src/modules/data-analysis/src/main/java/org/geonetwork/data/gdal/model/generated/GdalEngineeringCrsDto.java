...
/** GdalEngineeringCrsDto */
@JsonTypeName("engineering_crs")
@JacksonXmlRootElement(localName = "GdalEngineeringCrsDto")
@XmlRootElement(name = "GdalEngineeringCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalEngineeringCrsDto implements GdalCrsDto {
    ...
    public GdalEngineeringCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalEngineeringCrsDto(String name, Object datum) {
        this.name = name;
        this.datum = datum;
    }

    public GdalEngineeringCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalEngineeringCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalEngineeringCrsDto datum(Object datum) {
        this.datum = datum;
        return this;
    }
    ...
    public GdalEngineeringCrsDto coordinateSystem(Object coordinateSystem) {
    ...
    public GdalEngineeringCrsDto $schema(Object $schema) {
    ...
    public GdalEngineeringCrsDto scope(Object scope) {
    ...
    public GdalEngineeringCrsDto area(Object area) {
    ...
    public GdalEngineeringCrsDto bbox(Object bbox) {
    ...
    public GdalEngineeringCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalEngineeringCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalEngineeringCrsDto usages(Object usages) {
    ...
    public GdalEngineeringCrsDto remarks(Object remarks) {
    ...
    public GdalEngineeringCrsDto id(Object id) {
    ...
    public GdalEngineeringCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalEngineeringCrsDto engineeringCrs = (GdalEngineeringCrsDto) o;
        return Objects.equals(this.type, engineeringCrs.type)
                && Objects.equals(this.name, engineeringCrs.name)
                && Objects.equals(this.datum, engineeringCrs.datum)
                && Objects.equals(this.coordinateSystem, engineeringCrs.coordinateSystem)
                && equalsNullable(this.$schema, engineeringCrs.$schema)
                && equalsNullable(this.scope, engineeringCrs.scope)
                && equalsNullable(this.area, engineeringCrs.area)
                && equalsNullable(this.bbox, engineeringCrs.bbox)
                && equalsNullable(this.verticalExtent, engineeringCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, engineeringCrs.temporalExtent)
                && equalsNullable(this.usages, engineeringCrs.usages)
                && equalsNullable(this.remarks, engineeringCrs.remarks)
                && equalsNullable(this.id, engineeringCrs.id)
                && equalsNullable(this.ids, engineeringCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalEngineeringCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalEngineeringCrsDto instance;

        public Builder() {
            this(new GdalEngineeringCrsDto());
        }

        protected Builder(GdalEngineeringCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalEngineeringCrsDto value) {
        ...
        /**
         * returns a built GdalEngineeringCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalEngineeringCrsDto build() {
            try {
