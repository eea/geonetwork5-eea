...
/** GdalTemporalCrsDto */
@JsonTypeName("temporal_crs")
@JacksonXmlRootElement(localName = "GdalTemporalCrsDto")
@XmlRootElement(name = "GdalTemporalCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalTemporalCrsDto implements GdalCrsDto {
    ...
    public GdalTemporalCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalTemporalCrsDto(String name, Object datum) {
        this.name = name;
        this.datum = datum;
    }

    public GdalTemporalCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalTemporalCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalTemporalCrsDto datum(Object datum) {
        this.datum = datum;
        return this;
    }
    ...
    public GdalTemporalCrsDto coordinateSystem(Object coordinateSystem) {
    ...
    public GdalTemporalCrsDto $schema(Object $schema) {
    ...
    public GdalTemporalCrsDto scope(Object scope) {
    ...
    public GdalTemporalCrsDto area(Object area) {
    ...
    public GdalTemporalCrsDto bbox(Object bbox) {
    ...
    public GdalTemporalCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalTemporalCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalTemporalCrsDto usages(Object usages) {
    ...
    public GdalTemporalCrsDto remarks(Object remarks) {
    ...
    public GdalTemporalCrsDto id(Object id) {
    ...
    public GdalTemporalCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalTemporalCrsDto temporalCrs = (GdalTemporalCrsDto) o;
        return Objects.equals(this.type, temporalCrs.type)
                && Objects.equals(this.name, temporalCrs.name)
                && Objects.equals(this.datum, temporalCrs.datum)
                && Objects.equals(this.coordinateSystem, temporalCrs.coordinateSystem)
                && equalsNullable(this.$schema, temporalCrs.$schema)
                && equalsNullable(this.scope, temporalCrs.scope)
                && equalsNullable(this.area, temporalCrs.area)
                && equalsNullable(this.bbox, temporalCrs.bbox)
                && equalsNullable(this.verticalExtent, temporalCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, temporalCrs.temporalExtent)
                && equalsNullable(this.usages, temporalCrs.usages)
                && equalsNullable(this.remarks, temporalCrs.remarks)
                && equalsNullable(this.id, temporalCrs.id)
                && equalsNullable(this.ids, temporalCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalTemporalCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalTemporalCrsDto instance;

        public Builder() {
            this(new GdalTemporalCrsDto());
        }

        protected Builder(GdalTemporalCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalTemporalCrsDto value) {
        ...
        /**
         * returns a built GdalTemporalCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalTemporalCrsDto build() {
            try {
