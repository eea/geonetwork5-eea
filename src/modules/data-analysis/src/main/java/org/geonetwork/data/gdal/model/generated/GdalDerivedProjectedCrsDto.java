...
/** GdalDerivedProjectedCrsDto */
@JsonTypeName("derived_projected_crs")
@JacksonXmlRootElement(localName = "GdalDerivedProjectedCrsDto")
@XmlRootElement(name = "GdalDerivedProjectedCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalDerivedProjectedCrsDto implements GdalCrsDto {
    ...
    public GdalDerivedProjectedCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalDerivedProjectedCrsDto(String name, Object baseCrs, Object conversion, Object coordinateSystem) {
        this.name = name;
    ...
    public GdalDerivedProjectedCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalDerivedProjectedCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalDerivedProjectedCrsDto baseCrs(Object baseCrs) {
        this.baseCrs = baseCrs;
        return this;
    }
    ...
    public GdalDerivedProjectedCrsDto conversion(Object conversion) {
        this.conversion = conversion;
        return this;
    }
    ...
    public GdalDerivedProjectedCrsDto coordinateSystem(Object coordinateSystem) {
        this.coordinateSystem = coordinateSystem;
        return this;
    }
    ...
    public GdalDerivedProjectedCrsDto $schema(Object $schema) {
    ...
    public GdalDerivedProjectedCrsDto scope(Object scope) {
    ...
    public GdalDerivedProjectedCrsDto area(Object area) {
    ...
    public GdalDerivedProjectedCrsDto bbox(Object bbox) {
    ...
    public GdalDerivedProjectedCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalDerivedProjectedCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalDerivedProjectedCrsDto usages(Object usages) {
    ...
    public GdalDerivedProjectedCrsDto remarks(Object remarks) {
    ...
    public GdalDerivedProjectedCrsDto id(Object id) {
    ...
    public GdalDerivedProjectedCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalDerivedProjectedCrsDto derivedProjectedCrs = (GdalDerivedProjectedCrsDto) o;
        return Objects.equals(this.type, derivedProjectedCrs.type)
                && Objects.equals(this.name, derivedProjectedCrs.name)
                && Objects.equals(this.baseCrs, derivedProjectedCrs.baseCrs)
                && Objects.equals(this.conversion, derivedProjectedCrs.conversion)
                && Objects.equals(this.coordinateSystem, derivedProjectedCrs.coordinateSystem)
                && equalsNullable(this.$schema, derivedProjectedCrs.$schema)
                && equalsNullable(this.scope, derivedProjectedCrs.scope)
                && equalsNullable(this.area, derivedProjectedCrs.area)
                && equalsNullable(this.bbox, derivedProjectedCrs.bbox)
                && equalsNullable(this.verticalExtent, derivedProjectedCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, derivedProjectedCrs.temporalExtent)
                && equalsNullable(this.usages, derivedProjectedCrs.usages)
                && equalsNullable(this.remarks, derivedProjectedCrs.remarks)
                && equalsNullable(this.id, derivedProjectedCrs.id)
                && equalsNullable(this.ids, derivedProjectedCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalDerivedProjectedCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalDerivedProjectedCrsDto instance;

        public Builder() {
            this(new GdalDerivedProjectedCrsDto());
        }

        protected Builder(GdalDerivedProjectedCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalDerivedProjectedCrsDto value) {
        ...
        /**
         * returns a built GdalDerivedProjectedCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalDerivedProjectedCrsDto build() {
            try {
