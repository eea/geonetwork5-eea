...
public class GdalOgrinfoDatasetDto {
    ...
    @Valid
    private List<@Valid GdalLayerDto> layers = new ArrayList<>();
    ...
    public GdalOgrinfoDatasetDto(List<@Valid GdalLayerDto> layers, GdalMetadataDto metadata, GdalDomainsDto domains) {
        this.layers = layers;
    ...
    public int hashCode() {
        return Objects.hash(
                description, driverShortName, driverLongName, layers, metadata, domains, relationships, rootGroup);
    }
    ...
    public String toString() {
        ...
        sb.append("    driverShortName: ")
                .append(toIndentedString(driverShortName))
                .append("\n");
        sb.append("    driverLongName: ")
                .append(toIndentedString(driverLongName))
                .append("\n");
