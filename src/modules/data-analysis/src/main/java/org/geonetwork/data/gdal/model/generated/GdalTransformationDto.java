...
public class GdalTransformationDto implements GdalSingleOperationDto {
    ...
    public GdalTransformationDto(
            String name, Object sourceCrs, Object targetCrs, Object method, List<@Valid Object> parameters) {
        this.name = name;
    ...
    public String toString() {
        ...
        sb.append("    interpolationCrs: ")
                .append(toIndentedString(interpolationCrs))
                .append("\n");
