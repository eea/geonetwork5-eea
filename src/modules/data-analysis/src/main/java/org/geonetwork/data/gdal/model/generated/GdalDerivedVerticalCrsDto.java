...
/** GdalDerivedVerticalCrsDto */
@JsonTypeName("derived_vertical_crs")
@JacksonXmlRootElement(localName = "GdalDerivedVerticalCrsDto")
@XmlRootElement(name = "GdalDerivedVerticalCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalDerivedVerticalCrsDto implements GdalCrsDto {
    ...
    public GdalDerivedVerticalCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalDerivedVerticalCrsDto(String name, Object baseCrs, Object conversion, Object coordinateSystem) {
        this.name = name;
    ...
    public GdalDerivedVerticalCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalDerivedVerticalCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalDerivedVerticalCrsDto baseCrs(Object baseCrs) {
        this.baseCrs = baseCrs;
        return this;
    }
    ...
    public GdalDerivedVerticalCrsDto conversion(Object conversion) {
        this.conversion = conversion;
        return this;
    }
    ...
    public GdalDerivedVerticalCrsDto coordinateSystem(Object coordinateSystem) {
        this.coordinateSystem = coordinateSystem;
        return this;
    }
    ...
    public GdalDerivedVerticalCrsDto $schema(Object $schema) {
    ...
    public GdalDerivedVerticalCrsDto scope(Object scope) {
    ...
    public GdalDerivedVerticalCrsDto area(Object area) {
    ...
    public GdalDerivedVerticalCrsDto bbox(Object bbox) {
    ...
    public GdalDerivedVerticalCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalDerivedVerticalCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalDerivedVerticalCrsDto usages(Object usages) {
    ...
    public GdalDerivedVerticalCrsDto remarks(Object remarks) {
    ...
    public GdalDerivedVerticalCrsDto id(Object id) {
    ...
    public GdalDerivedVerticalCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalDerivedVerticalCrsDto derivedVerticalCrs = (GdalDerivedVerticalCrsDto) o;
        return Objects.equals(this.type, derivedVerticalCrs.type)
                && Objects.equals(this.name, derivedVerticalCrs.name)
                && Objects.equals(this.baseCrs, derivedVerticalCrs.baseCrs)
                && Objects.equals(this.conversion, derivedVerticalCrs.conversion)
                && Objects.equals(this.coordinateSystem, derivedVerticalCrs.coordinateSystem)
                && equalsNullable(this.$schema, derivedVerticalCrs.$schema)
                && equalsNullable(this.scope, derivedVerticalCrs.scope)
                && equalsNullable(this.area, derivedVerticalCrs.area)
                && equalsNullable(this.bbox, derivedVerticalCrs.bbox)
                && equalsNullable(this.verticalExtent, derivedVerticalCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, derivedVerticalCrs.temporalExtent)
                && equalsNullable(this.usages, derivedVerticalCrs.usages)
                && equalsNullable(this.remarks, derivedVerticalCrs.remarks)
                && equalsNullable(this.id, derivedVerticalCrs.id)
                && equalsNullable(this.ids, derivedVerticalCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalDerivedVerticalCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalDerivedVerticalCrsDto instance;

        public Builder() {
            this(new GdalDerivedVerticalCrsDto());
        }

        protected Builder(GdalDerivedVerticalCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalDerivedVerticalCrsDto value) {
        ...
        /**
         * returns a built GdalDerivedVerticalCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalDerivedVerticalCrsDto build() {
            try {
