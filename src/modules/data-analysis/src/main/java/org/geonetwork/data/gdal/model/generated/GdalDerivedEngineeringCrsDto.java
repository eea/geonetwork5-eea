...
/** GdalDerivedEngineeringCrsDto */
@JsonTypeName("derived_engineering_crs")
@JacksonXmlRootElement(localName = "GdalDerivedEngineeringCrsDto")
@XmlRootElement(name = "GdalDerivedEngineeringCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalDerivedEngineeringCrsDto implements GdalCrsDto {
    ...
    public GdalDerivedEngineeringCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalDerivedEngineeringCrsDto(String name, Object baseCrs, Object conversion, Object coordinateSystem) {
        this.name = name;
    ...
    public GdalDerivedEngineeringCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalDerivedEngineeringCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalDerivedEngineeringCrsDto baseCrs(Object baseCrs) {
        this.baseCrs = baseCrs;
        return this;
    }
    ...
    public GdalDerivedEngineeringCrsDto conversion(Object conversion) {
        this.conversion = conversion;
        return this;
    }
    ...
    public GdalDerivedEngineeringCrsDto coordinateSystem(Object coordinateSystem) {
        this.coordinateSystem = coordinateSystem;
        return this;
    }
    ...
    public GdalDerivedEngineeringCrsDto $schema(Object $schema) {
    ...
    public GdalDerivedEngineeringCrsDto scope(Object scope) {
    ...
    public GdalDerivedEngineeringCrsDto area(Object area) {
    ...
    public GdalDerivedEngineeringCrsDto bbox(Object bbox) {
    ...
    public GdalDerivedEngineeringCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalDerivedEngineeringCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalDerivedEngineeringCrsDto usages(Object usages) {
    ...
    public GdalDerivedEngineeringCrsDto remarks(Object remarks) {
    ...
    public GdalDerivedEngineeringCrsDto id(Object id) {
    ...
    public GdalDerivedEngineeringCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalDerivedEngineeringCrsDto derivedEngineeringCrs = (GdalDerivedEngineeringCrsDto) o;
        return Objects.equals(this.type, derivedEngineeringCrs.type)
                && Objects.equals(this.name, derivedEngineeringCrs.name)
                && Objects.equals(this.baseCrs, derivedEngineeringCrs.baseCrs)
                && Objects.equals(this.conversion, derivedEngineeringCrs.conversion)
                && Objects.equals(this.coordinateSystem, derivedEngineeringCrs.coordinateSystem)
                && equalsNullable(this.$schema, derivedEngineeringCrs.$schema)
                && equalsNullable(this.scope, derivedEngineeringCrs.scope)
                && equalsNullable(this.area, derivedEngineeringCrs.area)
                && equalsNullable(this.bbox, derivedEngineeringCrs.bbox)
                && equalsNullable(this.verticalExtent, derivedEngineeringCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, derivedEngineeringCrs.temporalExtent)
                && equalsNullable(this.usages, derivedEngineeringCrs.usages)
                && equalsNullable(this.remarks, derivedEngineeringCrs.remarks)
                && equalsNullable(this.id, derivedEngineeringCrs.id)
                && equalsNullable(this.ids, derivedEngineeringCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalDerivedEngineeringCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalDerivedEngineeringCrsDto instance;

        public Builder() {
            this(new GdalDerivedEngineeringCrsDto());
        }

        protected Builder(GdalDerivedEngineeringCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalDerivedEngineeringCrsDto value) {
        ...
        /**
         * returns a built GdalDerivedEngineeringCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalDerivedEngineeringCrsDto build() {
            try {
