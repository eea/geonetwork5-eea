...
/** GdalDerivedTemporalCrsDto */
@JsonTypeName("derived_temporal_crs")
@JacksonXmlRootElement(localName = "GdalDerivedTemporalCrsDto")
@XmlRootElement(name = "GdalDerivedTemporalCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalDerivedTemporalCrsDto implements GdalCrsDto {
    ...
    public GdalDerivedTemporalCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalDerivedTemporalCrsDto(String name, Object baseCrs, Object conversion, Object coordinateSystem) {
        this.name = name;
    ...
    public GdalDerivedTemporalCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalDerivedTemporalCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalDerivedTemporalCrsDto baseCrs(Object baseCrs) {
        this.baseCrs = baseCrs;
        return this;
    }
    ...
    public GdalDerivedTemporalCrsDto conversion(Object conversion) {
        this.conversion = conversion;
        return this;
    }
    ...
    public GdalDerivedTemporalCrsDto coordinateSystem(Object coordinateSystem) {
        this.coordinateSystem = coordinateSystem;
        return this;
    }
    ...
    public GdalDerivedTemporalCrsDto $schema(Object $schema) {
    ...
    public GdalDerivedTemporalCrsDto scope(Object scope) {
    ...
    public GdalDerivedTemporalCrsDto area(Object area) {
    ...
    public GdalDerivedTemporalCrsDto bbox(Object bbox) {
    ...
    public GdalDerivedTemporalCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalDerivedTemporalCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalDerivedTemporalCrsDto usages(Object usages) {
    ...
    public GdalDerivedTemporalCrsDto remarks(Object remarks) {
    ...
    public GdalDerivedTemporalCrsDto id(Object id) {
    ...
    public GdalDerivedTemporalCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalDerivedTemporalCrsDto derivedTemporalCrs = (GdalDerivedTemporalCrsDto) o;
        return Objects.equals(this.type, derivedTemporalCrs.type)
                && Objects.equals(this.name, derivedTemporalCrs.name)
                && Objects.equals(this.baseCrs, derivedTemporalCrs.baseCrs)
                && Objects.equals(this.conversion, derivedTemporalCrs.conversion)
                && Objects.equals(this.coordinateSystem, derivedTemporalCrs.coordinateSystem)
                && equalsNullable(this.$schema, derivedTemporalCrs.$schema)
                && equalsNullable(this.scope, derivedTemporalCrs.scope)
                && equalsNullable(this.area, derivedTemporalCrs.area)
                && equalsNullable(this.bbox, derivedTemporalCrs.bbox)
                && equalsNullable(this.verticalExtent, derivedTemporalCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, derivedTemporalCrs.temporalExtent)
                && equalsNullable(this.usages, derivedTemporalCrs.usages)
                && equalsNullable(this.remarks, derivedTemporalCrs.remarks)
                && equalsNullable(this.id, derivedTemporalCrs.id)
                && equalsNullable(this.ids, derivedTemporalCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalDerivedTemporalCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalDerivedTemporalCrsDto instance;

        public Builder() {
            this(new GdalDerivedTemporalCrsDto());
        }

        protected Builder(GdalDerivedTemporalCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalDerivedTemporalCrsDto value) {
        ...
        /**
         * returns a built GdalDerivedTemporalCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalDerivedTemporalCrsDto build() {
            try {
