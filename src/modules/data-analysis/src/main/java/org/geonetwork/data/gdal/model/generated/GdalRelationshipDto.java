...
public class GdalRelationshipDto {
    ...
    @Valid
    private List<String> leftTableFields = new ArrayList<>();

    @Valid
    private List<String> rightTableFields = new ArrayList<>();

    private String mappingTableName;

    @Valid
    private List<String> leftMappingTableFields = new ArrayList<>();

    @Valid
    private List<String> rightMappingTableFields = new ArrayList<>();
    ...
    public String toString() {
        ...
        sb.append("    relatedTableType: ")
                .append(toIndentedString(relatedTableType))
                .append("\n");
        ...
        sb.append("    rightTableName: ")
                .append(toIndentedString(rightTableName))
                .append("\n");
        sb.append("    leftTableFields: ")
                .append(toIndentedString(leftTableFields))
                .append("\n");
        sb.append("    rightTableFields: ")
                .append(toIndentedString(rightTableFields))
                .append("\n");
        sb.append("    mappingTableName: ")
                .append(toIndentedString(mappingTableName))
                .append("\n");
        ...
        sb.append("    rightMappingTableFields: ")
                ...
                .append("\n");
        sb.append("    forwardPathLabel: ")
                .append(toIndentedString(forwardPathLabel))
                .append("\n");
        sb.append("    backwardPathLabel: ")
                .append(toIndentedString(backwardPathLabel))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
