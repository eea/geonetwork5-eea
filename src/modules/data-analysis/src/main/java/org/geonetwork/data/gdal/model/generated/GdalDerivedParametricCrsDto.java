...
/** GdalDerivedParametricCrsDto */
@JsonTypeName("derived_parametric_crs")
@JacksonXmlRootElement(localName = "GdalDerivedParametricCrsDto")
@XmlRootElement(name = "GdalDerivedParametricCrsDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalDerivedParametricCrsDto implements GdalCrsDto {
    ...
    public GdalDerivedParametricCrsDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalDerivedParametricCrsDto(String name, Object baseCrs, Object conversion, Object coordinateSystem) {
        this.name = name;
    ...
    public GdalDerivedParametricCrsDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalDerivedParametricCrsDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalDerivedParametricCrsDto baseCrs(Object baseCrs) {
        this.baseCrs = baseCrs;
        return this;
    }
    ...
    public GdalDerivedParametricCrsDto conversion(Object conversion) {
        this.conversion = conversion;
        return this;
    }
    ...
    public GdalDerivedParametricCrsDto coordinateSystem(Object coordinateSystem) {
        this.coordinateSystem = coordinateSystem;
        return this;
    }
    ...
    public GdalDerivedParametricCrsDto $schema(Object $schema) {
    ...
    public GdalDerivedParametricCrsDto scope(Object scope) {
    ...
    public GdalDerivedParametricCrsDto area(Object area) {
    ...
    public GdalDerivedParametricCrsDto bbox(Object bbox) {
    ...
    public GdalDerivedParametricCrsDto verticalExtent(Object verticalExtent) {
    ...
    public GdalDerivedParametricCrsDto temporalExtent(Object temporalExtent) {
    ...
    public GdalDerivedParametricCrsDto usages(Object usages) {
    ...
    public GdalDerivedParametricCrsDto remarks(Object remarks) {
    ...
    public GdalDerivedParametricCrsDto id(Object id) {
    ...
    public GdalDerivedParametricCrsDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalDerivedParametricCrsDto derivedParametricCrs = (GdalDerivedParametricCrsDto) o;
        return Objects.equals(this.type, derivedParametricCrs.type)
                && Objects.equals(this.name, derivedParametricCrs.name)
                && Objects.equals(this.baseCrs, derivedParametricCrs.baseCrs)
                && Objects.equals(this.conversion, derivedParametricCrs.conversion)
                && Objects.equals(this.coordinateSystem, derivedParametricCrs.coordinateSystem)
                && equalsNullable(this.$schema, derivedParametricCrs.$schema)
                && equalsNullable(this.scope, derivedParametricCrs.scope)
                && equalsNullable(this.area, derivedParametricCrs.area)
                && equalsNullable(this.bbox, derivedParametricCrs.bbox)
                && equalsNullable(this.verticalExtent, derivedParametricCrs.verticalExtent)
                && equalsNullable(this.temporalExtent, derivedParametricCrs.temporalExtent)
                && equalsNullable(this.usages, derivedParametricCrs.usages)
                && equalsNullable(this.remarks, derivedParametricCrs.remarks)
                && equalsNullable(this.id, derivedParametricCrs.id)
                && equalsNullable(this.ids, derivedParametricCrs.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalDerivedParametricCrsDto {\n");
    ...
    public static class Builder {
        ...
        private GdalDerivedParametricCrsDto instance;

        public Builder() {
            this(new GdalDerivedParametricCrsDto());
        }

        protected Builder(GdalDerivedParametricCrsDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalDerivedParametricCrsDto value) {
        ...
        /**
         * returns a built GdalDerivedParametricCrsDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalDerivedParametricCrsDto build() {
            try {
