...
/** GdalTemporalDatumDto */
@JsonTypeName("temporal_datum")
@JacksonXmlRootElement(localName = "GdalTemporalDatumDto")
@XmlRootElement(name = "GdalTemporalDatumDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-09-13T15:07:19.066965162+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class GdalTemporalDatumDto implements GdalDatumDto {
    ...
    public GdalTemporalDatumDto() {
        super();
    }

    /** Constructor with only required parameters */
    public GdalTemporalDatumDto(String name, String calendar) {
        this.name = name;
        this.calendar = calendar;
    }

    public GdalTemporalDatumDto type(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GdalTemporalDatumDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GdalTemporalDatumDto calendar(String calendar) {
        this.calendar = calendar;
        return this;
    }
     ...
     */
    @NotNull
    @Schema(name = "calendar", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    public GdalTemporalDatumDto timeOrigin(String timeOrigin) {
     ...
     * @return timeOrigin
     */
    @Schema(name = "time_origin", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("time_origin")
    @JacksonXmlProperty(localName = "time_origin")
    @XmlElement(name = "time_origin")
    ...
    public GdalTemporalDatumDto $schema(Object $schema) {
    ...
    public GdalTemporalDatumDto scope(Object scope) {
    ...
    public GdalTemporalDatumDto area(Object area) {
    ...
    public GdalTemporalDatumDto bbox(Object bbox) {
    ...
    public GdalTemporalDatumDto verticalExtent(Object verticalExtent) {
    ...
    public GdalTemporalDatumDto temporalExtent(Object temporalExtent) {
    ...
    public GdalTemporalDatumDto usages(Object usages) {
    ...
    public GdalTemporalDatumDto remarks(Object remarks) {
    ...
    public GdalTemporalDatumDto id(Object id) {
    ...
    public GdalTemporalDatumDto ids(Object ids) {
    ...
    public boolean equals(Object o) {
        ...
        GdalTemporalDatumDto temporalDatum = (GdalTemporalDatumDto) o;
        return Objects.equals(this.type, temporalDatum.type)
                && Objects.equals(this.name, temporalDatum.name)
                && Objects.equals(this.calendar, temporalDatum.calendar)
                && Objects.equals(this.timeOrigin, temporalDatum.timeOrigin)
                && equalsNullable(this.$schema, temporalDatum.$schema)
                && equalsNullable(this.scope, temporalDatum.scope)
                && equalsNullable(this.area, temporalDatum.area)
                && equalsNullable(this.bbox, temporalDatum.bbox)
                && equalsNullable(this.verticalExtent, temporalDatum.verticalExtent)
                && equalsNullable(this.temporalExtent, temporalDatum.temporalExtent)
                && equalsNullable(this.usages, temporalDatum.usages)
                && equalsNullable(this.remarks, temporalDatum.remarks)
                && equalsNullable(this.id, temporalDatum.id)
                && equalsNullable(this.ids, temporalDatum.ids);
    }
    ...
    public String toString() {
        ...
        sb.append("class GdalTemporalDatumDto {\n");
        sb.append("    type: ").append(toIndentedString(type)).append("\n");
        sb.append("    name: ").append(toIndentedString(name)).append("\n");
        sb.append("    calendar: ").append(toIndentedString(calendar)).append("\n");
        sb.append("    timeOrigin: ").append(toIndentedString(timeOrigin)).append("\n");
    ...
    public static class Builder {
        ...
        private GdalTemporalDatumDto instance;

        public Builder() {
            this(new GdalTemporalDatumDto());
        }

        protected Builder(GdalTemporalDatumDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(GdalTemporalDatumDto value) {
            this.instance.setType(value.type);
            this.instance.setName(value.name);
            this.instance.setCalendar(value.calendar);
            this.instance.setTimeOrigin(value.timeOrigin);
        ...
        public Builder calendar(String calendar) {
            this.instance.calendar(calendar);
            return this;
        }

        public Builder timeOrigin(String timeOrigin) {
            this.instance.timeOrigin(timeOrigin);
            return this;
        }
        ...
        /**
         * returns a built GdalTemporalDatumDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public GdalTemporalDatumDto build() {
            try {
