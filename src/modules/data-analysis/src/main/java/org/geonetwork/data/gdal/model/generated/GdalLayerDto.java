...
public class GdalLayerDto {
    ...
    @Valid
    private List<@Valid GdalFeatureDto> features = new ArrayList<>();

    @Valid
    private List<@Valid GdalFieldDto> fields = new ArrayList<>();

    @Valid
    private List<@Valid GdalGeometryFieldDto> geometryFields = new ArrayList<>();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, metadata, fidColumnName, featureCount, features, fields, geometryFields);
    }
    ...
    public String toString() {
        ...
        sb.append("    geometryFields: ")
                .append(toIndentedString(geometryFields))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
