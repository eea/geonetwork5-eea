...
export class GcNewRecordPanelComponent extends GcBaseComponent {
  ...
  listOfIncludedAnalysisProperties = input<string>('', {
    alias: 'include-properties',
  });
  listOfExcludedAnalysisProperties = input<string>('', {
  ...
  override ngOnInit() {
    ...
    this.includeProperties &&
      this.includeProperties.set(
        this.listOfIncludedAnalysisProperties().split(',')
      );
    this.excludeProperties &&
      this.excludeProperties.set(
        this.listOfExcludedAnalysisProperties().split(',')
      );
  }
}
